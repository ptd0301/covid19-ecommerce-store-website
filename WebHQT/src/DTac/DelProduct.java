    ...
    public DelProduct() {
        ...
        jTextField3.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField3.getText().isEmpty()) {
                    jTextField3.setForeground(Color.LIGHT_GRAY);
                    jTextField3.setText("Mã sản phẩm cần xóa");
                }
            }
        });
        ...
        jButtonconfirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTextField3.getText().equals("Mã sản phẩm cần xóa")) {
...
//        });
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Xóa sản phẩm");
        ...
        jLabel2.setText("Nhập mã sản phẩm cần xóa:");

        jTextField3.setForeground(new java.awt.Color(102, 102, 102));
        jTextField3.setText("Mã sản phẩm cần xóa");

        Valid1.setText("Hãy nhập mã sản phẩm cần xóa");
