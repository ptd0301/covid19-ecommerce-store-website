 ...
 * @author Admin
 */
public class OrderReceived extends javax.swing.JFrame {
    ...
    public OrderReceived() {
        ...
        jButtonAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                OrderReceived fram3 = new OrderReceived();
                fram3.setVisible(true);
                OrderReceived.this.setVisible(false);
            }
        });
...
//        });
    ...
    private void initComponents() {
        ...
        jButton2.setText("Danh sách đơn hàng");
        ...
        jButton3.setText("Đơn hàng đã nhận");
        ...
        jTextField2.setText("Danh sách đơn hàng đã nhận");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã đơn hàng", "Mã khách hàng", "Địa chỉ", "Khu vực", "Phí vận chuyển", "Trạng thái"
            }
        ));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tổng đơn", "Đang giao", "Đã giao", "Đã hủy" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderReceived().setVisible(true);
            }
        });
    }
