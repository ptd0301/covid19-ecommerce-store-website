...
values ('KH000001', 'TK000007', N'Ngô Đỉnh Cao')
insert dbo.KHACH_HANG
values ('KH000002', 'TK000008', N'Nguyễn Mị Ly')
insert dbo.KHACH_HANG
values ('KH000003', 'TK000009', N'Trần Vô Thường')
insert dbo.KHACH_HANG
values ('KH000004', 'TK000010', N'Phan Như Ngọc')
insert dbo.KHACH_HANG
values ('KH000005', 'TK000011', N'Lê Đình Trung')
--select * from KHACH_HANG;
--delete dbo.KHACH_HANG;

----INSERT TABLE TAI_XE
insert dbo.TAI_XE
values ('TX000001', 'TK000012', N'Lý Cúc Bạch', '079441865021', '16-4P 4106', '107866816570', 50000)
insert dbo.TAI_XE
values ('TX000002', 'TK000013', N'Nguyễn Đình Phong', '079444098021', '45-8T 2578', '107423472589', 50000)
insert dbo.TAI_XE
values ('TX000003', 'TK000014', N'Trần Gia Bảo', '023781865021', '65-6D 2037', '425786816570', 50000)
insert dbo.TAI_XE
values ('TX000004', 'TK000015', N'Ngô Văn Dũng', '079441869804', '40-2R 4298', '107462016570', 50000)
insert dbo.TAI_XE
values ('TX000005', 'TK000016', N'Phạm Trường Giang', '079441860371', '57-9A 9641', '107866403058', 50000)
--select * from TAI_XE;
--delete dbo.TAI_XE;
...
values ('LH000001', N'Trang phục')
insert dbo.LOAI_HANG_HOA
values ('LH000002', N'Đồ gia dụng')
insert dbo.LOAI_HANG_HOA
values ('LH000003', N'Thiết bị điện tử')
insert dbo.LOAI_HANG_HOA
values ('LH000004', N'Sách')
insert dbo.LOAI_HANG_HOA
values ('LH000005', N'Thức ăn nhanh')
--select * from LOAI_HANG_HOA;
--delete dbo.LOAI_HANG_HOA;

----INSERT TABLE SAN_PHAM
insert dbo.SAN_PHAM
values ('SP000001', 'LH000002', N'Chảo chống dính', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000002', 'LH000001', N'Quần jean', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000003', 'LH000001', N'Áo phông', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000004', 'LH000003', N'Máy tính cầm tay', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000005', 'LH000002', N'Bộ dao 4 thanh', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000006', 'LH000004', N'Sách dạy nấu ăn', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000007', 'LH000005', N'Bim Bim', N'Mô tả')
insert dbo.SAN_PHAM
values ('SP000008', 'LH000004', N'Sách dạy con làm giàu', N'Mô tả')
--select * from SAN_PHAM;
--delete dbo.SAN_PHAM;

----INSERT TABLE DOI_TAC
insert dbo.DOI_TAC
values ('DT000001', 'TK000002', 'LH000001', N'Doanh nghiệp Rạng Đông', N'Lý Gia Thành', N'TP. Hồ Chí Minh', N'Quận 7', 6, 800)
insert dbo.DOI_TAC
values ('DT000002', 'TK000003', 'LH000001', N'Tập đoàn Đại Lợi', N'Phan Châu Liên', N'Cần Thơ', N'Quận 8', 4, 600)
insert dbo.DOI_TAC
values ('DT000003', 'TK000004', 'LH000004', N'Công ty TNHH Phương Hằng', N'Nguyễn Minh Tuyết', N'Đà Nẵng', N'Quận 5', 4, 400)
insert dbo.DOI_TAC
values ('DT000004', 'TK000005', 'LH000005', N'Tập đoàn Ngô Hào', N'Trần Tiến Đức', N'TP. Hồ Chí Minh', N'Quận 2', 5, 600)
insert dbo.DOI_TAC
values ('DT000005', 'TK000006', 'LH000002', N'Doanh nghiệp Minh Tiến', N'Phạm Nhật Hào', N'Hải Phòng', N'Quận 7', 3, 400)
--select * from DOI_TAC;
--delete dbo.DOI_TAC;
...
insert dbo.DON_HANG
values ('DH000001', 'KH000001', 'DT000004', null, 'CN000022', N'48B Đường HTA, Quận 6, Phường 14', N'Hà Nội', null, 20000, 10000, null, null, N'Tiền mặt')
insert dbo.DON_HANG
values ('DH000002', 'KH000002', 'DT000003', null, 'CN000012', N'57A Đường KVD, Quận 10, Phường 2', N'TP. Hồ CHí Minh', null, 15000, 5000, null, null, N'Thẻ tín dụng')
insert dbo.DON_HANG
...
insert dbo.DON_HANG
values ('DH000005', 'KH000005', 'DT000005', null, 'CN000016', N'76G Đường TQD, Quận 8, Phường 10', N'Tiền Giang', null, 30000, 5000, null, null, N'Thẻ ghi nợ')
...
values ('DH000001', 'SP000004', 2, 40000)
insert dbo.CHI_TIET_DH
values ('DH000001', 'SP000007', 2, 18000)
insert dbo.CHI_TIET_DH
values ('DH000001', 'SP000005', 1, 12000)
insert dbo.CHI_TIET_DH
values ('DH000002', 'SP000007', 1, 30000)
insert dbo.CHI_TIET_DH
values ('DH000002', 'SP000003', 1, 7000)
insert dbo.CHI_TIET_DH
values ('DH000003', 'SP000001', 2, 60000)
insert dbo.CHI_TIET_DH
...
insert dbo.CHI_TIET_DH
values ('DH000005', 'SP000003', 1, 21000)
insert dbo.CHI_TIET_DH
values ('DH000005', 'SP000002', 2, 14000)
